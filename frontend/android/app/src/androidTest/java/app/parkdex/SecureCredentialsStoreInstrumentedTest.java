...
public class SecureCredentialsStoreInstrumentedTest {
    ...
    public void persistsEncryptedCredentialAcrossStoreInstances() throws Exception {
        ...
        assertFalse(diskValue.contains("raw-bearer-token"));
        // getNoBackupFilesDir keeps the encrypted file outside backup-managed app data.
        assertEquals(context.getNoBackupFilesDir(), store.fileForTests().getParentFile());
    }
