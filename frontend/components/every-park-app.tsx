...
import { ArrowUpRight, Award, Check, ChevronDown, Compass, LandPlot, ListFilter, LocateFixed, LogIn, LogOut, MailCheck, Map as MapIcon, MapPin, RotateCcw, Search, Trees, Trash2, UserRound, X } from "lucide-react";
...
function AccountView({ apiBaseUrl, account, authenticated, sessionAuthenticated, loading, busy, guestProgressAvailable, onAuth, onGoogleAuth, onRequestVerification, onConfirmVerification, onImport, onLogout, onReset, badges, places, visitTimestamps, choosePlace }: AccountViewProps) {
  ...
  function backToLogin() { setPasswordResetOpen(false); setMode("login"); setError(""); setNotice(""); }
