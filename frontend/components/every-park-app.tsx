...
export function ParkdexApp({ apiBaseUrl }: { apiBaseUrl: string }) {
  ...
  useEffect(() => {
    function nativeBack(event: Event) {
      ...
      else if (searchExpanded || mapSearch) { setSearchExpanded(false); setMapSearch(""); }
  ...
  }, [celebrationBadges.length, mapSearch, searchExpanded, selectedId, showFilters, showNearby, view]);
