...
export function ParkdexApp(props: { apiBaseUrl: string; googleAuthAllowed?: boolean; geolocationAllowed?: boolean; automaticLocationAllowed?: boolean }) {
  ...
  const {
    ...
    earnedBadges, selected, selectedPlacePhotoUrl, claimsAvailable, legacyVisitCreationAvailable, claimFlow, claimFlowResetSignal,
    displayedRecommendation, liveClaimPlace, arrivalPhotoUrl, approximateClaimLocation, visits, photoOwnerKey,
...
function PlaceDetail({ expanded, onExpand, place, visit, visited, busy, authenticated, claimsAvailable, legacyVisitCreationAvailable, recommendClaim, createClaim, reconcileClaim, uploadPhoto, loadPhoto, removePhoto, ownerKey, photoUrl, onClaimed, onOpenPlace, groupsState, boundaryState, onClose, onToggle, openCollection }: {
  expanded: boolean;
  onExpand: () => void;
  place: Place;
  visit?: Visit;
