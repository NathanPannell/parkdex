...
export function ParkdexApp(props: { apiBaseUrl: string; googleAuthAllowed?: boolean; geolocationAllowed?: boolean; automaticLocationAllowed?: boolean }) {
  ...
  const {
    ...
    groupSelectedIds, boundaryLoadState, groupMapMode, mapFiltered, mapSearchMatches, groups, badgeList,
  ...
  }, [persistentSyncMessage, storageUnavailable]);
