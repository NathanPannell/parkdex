...
describe("ClaimVisitPanel", () => {
  it("keeps logged-out place details informational and does not call claim or photo APIs", async () => {
  ...
  it("clears restored photo and recommendation state when the account owner changes", async () => {
    const photo = new File(["photo"], "visit.jpg", { type: "image/jpeg" });
