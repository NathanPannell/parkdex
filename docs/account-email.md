...
3. Set `APP_PUBLIC_URL` to the browser URL for the environment, such as `https://staging.web.parkdex.app` or an isolated preview URL. Production uses `https://web.parkdex.app`.
